...
if (location.hostname.indexOf('bwin.es')+1) mmcore.cookie_domain = '.bwin.es'; // add cookie domain for bwin.es
else if (location.hostname.indexOf('bwin.it')+1) mmcore.cookie_domain = '.bwin.it'; // add cookie domain for bwin.it
else if (location.hostname.indexOf('bwin.fr')+1) mmcore.cookie_domain = '.bwin.fr'; // add cookie domain for bwin.fr
else if (location.hostname.indexOf('bwin.co.ar')+1) mmcore.cookie_domain = '.bwin.co.ar'; // add cookie domain for bwin.co.ar
else if (location.hostname.indexOf('betoto.com')+1) mmcore.cookie_domain = '.betoto.com'; // add cookie domain for betoto.com
else if (location.hostname.indexOf('gamebookers.com')+1) mmcore.cookie_domain = '.gamebookers.com'; // add cookie domain for gamebookers.com

/***** PERS CRIT UPDATED VERSION 12/07/13 *****/
