...
/*-=- Contents of mobile/scripts/lib/jquery.colorbox.min.js -=-*/
...
(function(n, t, i) {
    ...
    function v(n, t) {
        return Math.round((/%/.test(n) ? (t === "x" ? l.width() : l.height()) / 100 : 1) * parseInt(n, 10))
    }

    function yi(n) {
        return r.photo || r.photoRegex.test(n)
    }

    function di(n) {
        return r.retinaUrl && i.devicePixelRatio > 1 ? n.replace(r.photoRegex, r.retinaSuffix) : n
    }

    function pi() {
        var t, i = n.data(y, k);
        i == null ? (r = n.extend({}, kt), console && console.log && console.log("Error: cboxElement missing settings object")) : r = n.extend({}, i);
        for (t in r) n.isFunction(r[t]) && t.slice(0, 2) !== "on" && (r[t] = r[t].call(y));
    ...
    function gi() {
        var l, n = h + "Slideshow_",
            i = "click." + h,
            u, f, s, t;
        r.slideshow && c[1] ? (u = function() {
            clearTimeout(l)
        }, f = function() {
            (r.loop || c[p + 1]) && (l = setTimeout(e.next, r.slideshowSpeed))
        }, s = function() {
            ht.html(r.slideshowStop).unbind(i).one(i, t);
            et.bind(gt, f).bind(dt, u).bind(ni, t);
            o.removeClass(n + "off").addClass(n + "on")
        }, t = function() {
            u();
            et.unbind(gt, f).unbind(dt, u).unbind(ni, t);
            ht.html(r.slideshowStart).unbind(i).one(i, function() {
                e.next();
                s()
            });
            o.removeClass(n + "on").addClass(n + "off")
        }, r.slideshowAuto ? s() : t()) : o.removeClass(n + "off " + n + "on")
    }

    function wi(t) {
        if (!wt) {
            if (y = t, pi(), c = n(y), p = 0, r.rel !== "nofollow" && (c = n("." + ft).filter(function() {
                var t = n.data(this, k),
                    i;
                return t && (i = n(this).data("rel") || t.rel || this.rel), i === r.rel
            }), p = c.index(y), p === -1 && (c = c.add(y), p = c.length - 1)), !it) {
                if (it = at = !0, o.css({
                    visibility: "hidden",
                    display: "block"
                }), a = u(f, "LoadedContent", "width:0; height:0; overflow:hidden").appendTo(w), d = ti.height() + ui.height() + w.outerHeight(!0) - w.height(), g = ii.width() + ri.width() + w.outerWidth(!0) - w.width(), nt = a.outerHeight(!0), tt = a.outerWidth(!0), r.returnFocus) {
                    n(y).blur();
                    et.one(ai, function() {
                        n(y).focus()
                    })
                ...
                r.w = v(r.initialWidth, "x");
                r.h = v(r.initialHeight, "y");
                e.position();
                yt && l.bind("resize." + pt + " scroll." + pt, function() {
                    b.css({
                        width: l.width(),
                        height: l.height(),
                        top: l.scrollTop(),
    ...
    function bi() {
        !o && t.body && (li = !1, l = n(i), o = u(f).attr({
            id: k,
            "class": ot ? h + (yt ? "IE6" : "IE") : ""
        }).hide(), b = u(f, "Overlay", yt ? "position:absolute" : "").hide(), fi = u(f, "LoadingOverlay").add(u(f, "LoadingGraphic")), rt = u(f, "Wrapper"), w = u(f, "Content").append(ei = u(f, "Title"), oi = u(f, "Current"), ct = u(f, "Next"), lt = u(f, "Previous"), ht = u(f, "Slideshow"), si = u(f, "Close")), rt.append(u(f).append(u(f, "TopLeft"), ti = u(f, "TopCenter"), u(f, "TopRight")), u(f, !1, "clear:left").append(ii = u(f, "MiddleLeft"), w, ri = u(f, "MiddleRight")), u(f, !1, "clear:left").append(u(f, "BottomLeft"), ui = u(f, "BottomCenter"), u(f, "BottomRight"))).find("div div").css({
            float: "left"
        }), st = u(f, !1, "position:absolute; width:9999px; visibility:hidden; display:none"), hi = ct.add(lt).add(oi).add(ht), n(t.body).append(b, o.append(rt, st)))
    }

    function nr() {
        function i(n) {
            n.which > 1 || n.shiftKey || n.altKey || n.metaKey || (n.preventDefault(), wi(this))
        }
        if (o) {
            if (!li)
                if (li = !0, ct.click(function() {
                    e.next()
                }), lt.click(function() {
                    e.prev()
                }), si.click(function() {
                    ...
                    var t = n.keyCode;
                    it && r.escKey && t === 27 && (n.preventDefault(), e.close());
                    it && r.arrowKey && c[1] && (t === 37 ? (n.preventDefault(), lt.click()) : t === 39 && (n.preventDefault(), ct.click()))
                }), n.isFunction(n.fn.on)) n(t).on("click." + h, "." + ft, i);
                else n("." + ft).live("click." + h, i);
            return !0
        }
        return !1
    }
    var kt = {
        ...
        ai = h + "_closed",
        vt = h + "_purge",
        ot = !n.support.leadingWhitespace,
        yt = ot && !i.XMLHttpRequest,
        pt = h + "_IE6",
        b, o, rt, w, ti, ii, ri, ui, c, l, a, st, fi, ei, oi, ht, ct, lt, si, hi, et = n({}),
        r, d, g, nt, tt, y, p, s, it, at, wt, vi, e, f = "div",
        ci, li;
    n.colorbox || (n(bi), e = n.fn[k] = n[k] = function(t, i) {
        var r = this;
        if (t = t || {}, bi(), nr()) {
            ...
            i && (t.onComplete = i);
            r.each(function() {
                n.data(this, k, n.extend({}, n.data(this, k) || kt, t))
            }).addClass(ft);
            (n.isFunction(t.open) && t.open.call(r) || t.open) && wi(r[0])
        }
        return r
    }, e.position = function(n, t) {
        function y(n) {
            ti[0].style.width = ui[0].style.width = w[0].style.width = parseInt(n.style.width, 10) - g + "px";
            w[0].style.height = ii[0].style.height = ri[0].style.height = parseInt(n.style.height, 10) - d + "px"
        }
        var u, f = 0,
            s = 0,
            i = o.offset(),
        ...
        c = l.scrollTop();
        a = l.scrollLeft();
        r.fixed && !yt ? (i.top -= c, i.left -= a, o.css({
            position: "fixed"
        })) : (f = c, s = a, o.css({
            position: "absolute"
        }));
        s += r.right !== !1 ? Math.max(l.width() - r.w - tt - g - v(r.right, "x"), 0) : r.left !== !1 ? v(r.left, "x") : Math.round(Math.max(l.width() - r.w - tt - g, 0) / 2);
        f += r.bottom !== !1 ? Math.max(l.height() - r.h - nt - d - v(r.bottom, "y"), 0) : r.top !== !1 ? v(r.top, "y") : Math.round(Math.max(l.height() - r.h - nt - d, 0) / 2);
        o.css({
            top: i.top,
            left: i.left,
            visibility: "visible"
        });
        n = o.width() === r.w + tt && o.height() === r.h + nt ? 0 : n || 0;
        ...
        o.dequeue().animate(u, {
            ...
            complete: function() {
                y(this);
                at = !1;
                rt[0].style.width = r.w + tt + g + "px";
                rt[0].style.height = r.h + nt + d + "px";
                r.reposition && setTimeout(function() {
                    l.bind("resize." + h, e.position)
                }, 1);
                t && t()
            },
            step: function() {
        ...
        it && (n = n || {}, n.width && (r.w = v(n.width, "x") - tt - g), n.innerWidth && (r.w = v(n.innerWidth, "x")), a.css({
            width: r.w
        }), n.height && (r.h = v(n.height, "y") - nt - d), n.innerHeight && (r.h = v(n.innerHeight, "y")), n.innerHeight || n.height || (a.css({
            height: "auto"
        }), r.h = a.height()), a.css({
            height: r.h
        }), e.position(r.transition === "none" ? 0 : r.speed))
    }, e.prep = function(t) {
        function v() {
        ...
        if (it) {
            ...
            a.empty().remove();
            a = u(f, "LoadedContent").append(t);
            a.hide().appendTo(st.show()).css({
                width: v(),
            ...
            i = function() {
                function y() {
                    ot && o[0].style.removeAttribute("filter")
                }
                var i = c.length,
                    t, e = "frameBorder",
                    v = "allowTransparency",
                ...
                if (it) {
                    if (f = function() {
                        ...
                        ut(gt, r.onComplete)
                    }, ot && s && a.fadeIn(100), ei.html(r.title).add(a).show(), i > 1 ? (typeof r.current == "string" && oi.html(r.current.replace("{current}", p + 1).replace("{total}", i)).show(), ct[r.loop || p < i - 1 ? "show" : "hide"]().html(r.next), lt[r.loop || p ? "show" : "hide"]().html(r.previous), r.slideshow && ht.show(), r.preloading && n.each([bt(-1), bt(1)], function() {
                        var t, u, r = c[this],
                            i = n.data(r, k);
                        i && i.href ? (t = i.href, n.isFunction(t) && (t = t.call(r))) : t = n(r).attr("href");
                        t && (yi(t) || i.photo) && (u = new Image, u.src = t)
                    })) : hi.hide(), r.iframe) {
                        t = u("iframe")[0];
                        e in t && (t[e] = 0);
                        v in t && (t[v] = "true");
                        ...
                        }).one("load", f).appendTo(a);
                        et.one(vt, function() {
                            t.src = "//about:blank"
                        });
                        r.fastIframe && n(t).trigger("load")
                    } else f();
                    r.transition === "fade" ? o.fadeTo(l, 1, y) : y()
                }
            };
            r.transition === "fade" ? o.fadeTo(l, 0, function() {
                e.position(0, i)
            }) : e.position(l, i)
        }
    }, e.load = function(t) {
        var l, it, k = e.prep,
            rt;
        if (at = !0, s = !1, y = c[p], t || pi(), ci && o.add(b).removeClass(ci), r.className && o.add(b).addClass(r.className), ci = r.className, ut(vt), ut(dt, r.onLoad), r.h = r.height ? v(r.height, "y") - nt - d : r.innerHeight && v(r.innerHeight, "y"), r.w = r.width ? v(r.width, "x") - tt - g : r.innerWidth && v(r.innerWidth, "x"), r.mw = r.w, r.mh = r.h, r.maxWidth && (r.mw = v(r.maxWidth, "x") - tt - g, r.mw = r.w && r.w < r.mw ? r.w : r.mw), r.maxHeight && (r.mh = v(r.maxHeight, "y") - nt - d, r.mh = r.h && r.h < r.mh ? r.h : r.mh), l = r.href, vi = setTimeout(function() {
            fi.appendTo(w)
        }, 100), r.inline) {
            rt = u(f).hide().insertBefore(n(l)[0]);
            et.one(vt, function() {
                rt.replaceWith(a.children())
            });
            k(n(l))
        } else if (r.iframe) k(" ");
        else if (r.html) k(r.html);
        else if (yi(l)) {
            l = di(l);
            n(s = new Image).addClass(h + "Photo").bind("error", function() {
                r.title = !1;
                k(u(f, "Error").html(r.imgError))
            }).one("load", function() {
                var n;
                r.retinaImage && i.devicePixelRatio > 1 && (s.height = s.height / i.devicePixelRatio, s.width = s.width / i.devicePixelRatio);
                r.scalePhotos && (it = function() {
                    s.height -= s.height * n;
                    s.width -= s.width * n
                }, r.mw && s.width > r.mw && (n = (s.width - r.mw) / s.width, it()), r.mh && s.height > r.mh && (n = (s.height - r.mh) / s.height, it()));
                r.h && (s.style.marginTop = Math.max(r.mh - s.height, 0) / 2 + "px");
                c[1] && (r.loop || c[p + 1]) && (s.style.cursor = "pointer", s.onclick = function() {
                    e.next()
                });
                ot && (s.style.msInterpolationMode = "bicubic");
                setTimeout(function() {
                    k(s)
                }, 1)
            });
        ...
        } else l && st.load(l, r.data, function(t, i) {
            k(i === "error" ? u(f, "Error").html(r.xhrError) : n(this).contents())
        })
    }, e.next = function() {
        !at && c[1] && (r.loop || c[p + 1]) && (p = bt(1), e.load())
    }, e.prev = function() {
        !at && c[1] && (r.loop || p) && (p = bt(-1), e.load())
    }, e.close = function() {
        it && !wt && (wt = !0, it = !1, ut(ni, r.onCleanup), l.unbind("." + h + " ." + pt), b.fadeTo(200, 0), o.stop().fadeTo(300, 0, function() {
            o.add(b).css({
                opacity: 1,
                cursor: "auto"
            }).hide();
        ...
        n([]).add(o).add(b).remove();
        o = null;
        n("." + ft).removeData(k).removeClass(ft);
        n(t).unbind("click." + h)
    }, e.element = function() {
        return n(y)
    }, e.settings = kt)
...
/*-=- Contents of mobile/scripts/mobile-main.min.js -=-*/

(function(n) {
    n(function() {
        n(".lightbox").each(function(t) {
            n(this).find("a").colorbox({
                rel: "group" + t,
                transition: "fade",
                speed: 150,
