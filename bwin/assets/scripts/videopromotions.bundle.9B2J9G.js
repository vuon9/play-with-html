/*-=- Contents of sports/scripts/bundles/core-sports.bundle.js -=-*/
...
$.fn.processUserSateRowData = function(n) {
    return n
},
function(n) {
    "use strict";
        ...
        n.bwin.userstaterow.refresh = function(t) {
            ...
            n.ajax({
                ...
                success: function(t) {
                    ...
                    f = n(t);
                    f.find(u).val(o);
                    f = n.fn.processUserSateRowData(f);
                    i.html(f);
...
/*-=- Contents of scripts/plugins/jquery.bwin.modal.min.js -=-*/

(function(n, t, i) {
    "use strict";
    n(function() {
        n.bwin || (n.bwin = {});
        n.bwin.modal = function() {
            var u, f, e, r = {
                    postMessage: function(i) {
                        var r, u = t.name.match(/modal:(https?:\/\/.+)/i);
                        u && (i[".dialog"] = "modal", r = u[1], n.postMessage(i, r, t.parent))
                    },
                    receiveMessage: function(t) {
                        n.receiveMessage(t, e)
                    }
                };
            e = function(r) {
                var u = n("html").data().domain || t.location.protocol + "//" + t.location.hostname,
                    f = function(n) {
                        var t = i.createElement("a");
                        return t.href = n, t.protocol + "//" + t.hostname
                    }(r);
                return f.indexOf(u, f.length - u.length) !== -1
            };
            f = {
                close: function() {
                    n("#modal-iframe").remove();
                    n.bwin.dialog.close();
                    n.bwin.publish("/bwin/modal/close", [])
                },
                show: function(i) {
                    var r = n("#modal-iframe"),
                        u;
                    r.length === 0 || r.is(":visible") || (r.show(), u = {
                        body: r.eq(0),
                        showCloseIcon: i.showCloseIcon === "true"
                    }, i.width && (u.width = i.width, u.left = i.left || Math.round((parseInt(n(t).width(), 10) - i.width) / 2)), n.bwin.dialog(u), n.bwin.publish("/bwin/modal/show", [{
                        url: r.attr("src")
                    }]))
                },
                resize: function(t) {
            ...
            u = function(t) {
                var i = n.deparam(t.data) || {}, u = i[".dialog"],
                    r = f[i.method];
                u === "modal" && r && r(i)
            };
            t.top === t.self && r.receiveMessage(u);
            n.bwin.modal.close = function() {
                r.postMessage({
                    method: "close"
                })
            };
            n.bwin.modal.show = function(n) {
                r.postMessage({
                    method: "show",
                    width: n.width,
                    height: n.height,
                    left: n.left,
                    showCloseIcon: n.showCloseIcon !== undefined ? n.showCloseIcon : !0
                })
            };
            n.bwin.modal.resize = function(n) {
                r.postMessage({
                    method: "resize",
                    width: n.width,
                    height: n.height
...
/*-=- Contents of scripts/plugins/jquery.bwin.reminder.min.js -=-*/

(function(n, t) {
    "use strict";
    n(function() {
        n.bwin || (n.bwin = {});
        n.bwin.reminder = function() {
            var i = n("html").data() ? n("html").data().domain : t.location.host;
            return n.bwin.subscribe("/bwin/modal/close", function() {
                var t = n("#bonus-reminder"),
                    i = n.cookie("bonus-min"),
                    r = t.is(":visible");
                i && !r ? t.fadeIn().find("a").attr("href", n.cookie("bonus-min") || "#") : !i && r && t.fadeOut()
            }), n.bwin.subscribe("/bwin/modal/show", function(t, r) {
                var u = n.cookie("bonus-min");
                u === r.url && (n("#bonus-reminder").fadeOut(), n.removeCookie("bonus-min", {
                    path: "/",
                    domain: i
                }))
            }), n.bwin.reminder.setActive = function(t) {
                n.cookie("bonus-min", t, {
                    path: "/",
                    domain: i
                });
                n.bwin.modal.close()
            }, n("#bonus-reminder").each(function(i, r) {
                var u = n(r);
                return n.cookie("bonus-min") && u.show().find("a").attr("href", n.cookie("bonus-min") || "#"), u.find("a:first").click(function(i) {
                    i.preventDefault();
                    var r = n("#modal-iframe"),
                        u = n.cookie("bonus-min");
                    u.length < 1 || r.length === 0 && (r = n('<iframe name="modal:' + n("<div/>").text(t.location.href).html() + '" />'), r.attr({
                        id: "modal-iframe",
                        src: u,
                        scrolling: "no",
                        frameborder: "0",
...
(function(n) {
    ...
    function c() {
        n("#main-wrap").on("click", "div.uni-button", function() {
    ...
    n(function() {
        ...
        n.bwin.signupbonus();
        n.bwin.tracking();
        n.bwin.personalbutton && n.bwin.personalbutton();
        n.bwin.langswitch && n.bwin.langswitch();
...
/*-=- Contents of scripts/plugins/jquery.bwin.override.min.js -=-*/
...
/*-=- Contents of sports/scripts/plugins/jquery.bwin.lowresourcedevice.min.js -=-*/

(function(n) {
    n(function() {
        var f;
        n.bwin === undefined && (n.bwin = {});
        var i = navigator.userAgent.match(/MSIE\s([(0-7).]+)/),
            r = i && i[1] && parseFloat(i[1]) <= 7,
            t = !1,
            u = n("script[data-rel=device-profiles-configuration]");
        u.length > 0 && (f = n.parseJSON(u.html()), t = f.ForceHighResourceDevice);
        n.bwin.lowresourcedevice = function() {
            r && !t && (n.fx.off = !0, n("#fallback-panel").css({
                display: "block"
            }))
        };
        n.bwin.onHighResourceDevice = function(n) {
            (!r || t) && n()
        };
        n.bwin.onLowResourceDevice = function(n) {
            r && !t && n()
        }
    })
})(jQuery);

/*-=- Contents of sports/scripts/plugins/jquery.bwin.browserupdate.min.js -=-*/

(function(n) {
    n(function() {
        n.bwin === undefined && (n.bwin = {});
        n.bwin.browserupdate = function() {
            var r = "iewarning",
                u = n.cookie(r),
                i = u ? n.deparam(u) : {}, t = n("div.upgrade");
            i.closed && t.hide();
            t.children("span.close").click(function() {
                t.hide();
                i.closed = !0;
                n.cookie(r, n.param(i), {});
                n.bwin.tracking.trackEventData({
                    Values: [
                        ["pageName", "BrowserUpgradeClose"]
                    ]
                })
            });
            t.find(".uni-button").bwin_hover()
        }
    })
})(jQuery);

/*-=- Contents of sports/scripts/plugins/jquery.bwin.videos.min.js -=-*/
...
(function(n) {
    n(function() {
        ...
        var g = [{
            ...
            t = n("#video-player-container"),
            i = n("#video-promotions"),
            u = null,
            f = null,
            e = !1,
            o = !1,
            r = !1,
            s = !1;
        n.bwin.videos = function() {
            ot()
        };
        var nt = function(n) {
            t.height(n);
            t.children("#player").attr("height", n).find("embed").attr("height", n)
        }, tt = function(t) {
                var i = {
                    Id: "Flash tracking",
                    Group: "Videos",
                    EventType: n.bwin.omniture.PARTIALPAGE_EVENT,
                    Values: []
                }, r = [],
                    u, f;
                n("script[data-rel=TrackingData]").length > 0 && (r = n.parseJSON(n("script[data-rel=TrackingData]").html()));
                u = [];
                r.length > 0 && (f = r[0], u = f.Values);
                _.each(g, function(n) {
                    for (var r in t) n.old.toUpperCase() == r.toString().toUpperCase() && i.Values.push([n.name, t[r]])
                });
                _.each(u, function(n) {
                    _.any(i.Values, function(t) {
                        return t[0] == n[0]
                    }) || i.Values.push(n)
                });
                n.bwin.tracking.trackEventData(i)
            }, it = function() {
                var t = [];
                return n("script[data-rel=VideosData]").length > 0 && (t = n.parseJSON(n("script[data-rel=VideosData]").html())), t
            }, rt = function() {
                var t = [];
                return n("script[data-rel=TranslationsData]").length > 0 && (t = n.parseJSON(n("script[data-rel=TranslationsData]").html())), t
            }, v = function() {
                for (var s = t.data(), h = n.bwin.flash.getVersion(), f = h.split(","), e = s.minimalFlashVersion.split(","), o = Math.min(f.length, e.length), r, u, i = 0; i < o; i++)
                    if (r = parseInt(f[i]), u = parseInt(e[i]), r >= u)
                        if (i + 1 < o && r == u) continue;
                        else return !0;
                        else return !1;
                return !1
            }, h = function(n, t) {
                if (r) return !1;
                e == !0 && o == !0 ? (t.attr("poster", n.pictureUrl), t.find("#video-mp4").attr("src", n.mp4VideoUrl), t.find("#video-webm").attr("src", n.webmVideoUrl), s = !0) : window.setTimeout(h(n, t), 100)
            }, y = function(n) {
                !r && s && window.setTimeout(y, 100);
                i.find("#video-details").html(n);
                t = i.find("#video-player-container");
                s == !0 && window.vjs && !window.vjs.IS_IOS && window.vjs.autoSetup()
            }, p = function() {
                if (r) return !1;
                if (e == !0 && o == !0) {
                    var u = t.data();
                    n.ajax({
                        url: u.videoPlayerUrl,
                        cache: !0,
                        success: function(r) {
                            t = i.find("#video-player-container");
                            var f = n(r);
                            h(u, f);
                            t.html(f);
                            window.vjs && !window.vjs.IS_IOS && window.vjs.autoSetup()
                        }
                    })
                } else window.setTimeout(p, 100)
            }, w = function(n, t) {
                return t && n && n.requiresLogin == "True" ? (et(n, t), !1) : !0
            }, b = function(t) {
                u = null;
                f = null;
                t && t.videoPlayerDataUrl && n.ajax({
                    url: t.videoPlayerDataUrl + "/" + t.selectedVideo,
                    cache: !0,
                    async: !1,
                    success: function(n) {
                        u = n.mp4CheckUrl;
                        f = n.webmCheckUrl;
                        t.pictureUrl = n.pictureUrl
                    }
                })
            }, k = function(t, i) {
                e = !1;
                ...
                u && f ? (n.ajax({
                    ...
                    async: !1,
                    success: function(u) {
                        var f = n(u).find("token");
                        f && f.attr("status") == "0" ? t.mp4VideoUrl = f.attr("url") + "?auth=" + f.attr("auth") : (l(t, i), r = !0)
                    },
                    complete: function() {
                        e = !r
                    }
                    ...
                    success: function(u) {
                        var f = n(u).find("token");
                        f && f.attr("status") == "0" ? t.webmVideoUrl = f.attr("url") + "?auth=" + f.attr("auth") : (l(t, i), r = !0)
                    },
                    complete: function() {
                        o = !r
                    }
            ...
            d = window.Modernizr && window.Modernizr.video,
            ft = function() {
                if (t.length > 0) {
                    var i = t.data();
                    n.ajax({
                ...
                return i && t && t.countryBlockedVideoUrl && n.ajax({
                    url: t.countryBlockedVideoUrl,
                    cache: !0,
                    success: function(n) {
                        i.addClass("countryBlockedVideo");
                        i.html(n)
                    }
                }), !1
            }, et = function(t, i) {
                return i && t && t.notLoggedInUrl && n.ajax({
                    url: t.notLoggedInUrl,
                    cache: !0,
                    success: function(n) {
                        i.addClass("notloggedin");
                        i.html(n)
                    }
                }), !1
            }, ot = function() {
                c || (d ? (n.support.cors = !0, ut()) : ft());
                i.on("click", "#videos-list > ul a[href]", function(r) {
                    if (n(this).hasClass("selected")) return !1;
                    r.preventDefault();
                    n(this).closest("ul").find("a.selected").removeClass("selected");
                    n(this).addClass("selected");
                    var f = n(this).data(),
                        u = f.videoDetailsUrl;
                    return !c && d && (u = u + "/true"), n.ajax({
                        url: u,
                        cache: !0,
                        success: function(r) {
                            var e = n(r),
                                u, f;
                            if (c) i.find("#video-details").html(e), t = i.find("#video-player-container"), a();
                            else {
                                if (u = e.filter("#video-player-container"), f = u.data(), !w(f, u)) return i.find("#video-details").html(e), t = i.find("#video-player-container"), !1;
                                b(f);
                                k(f, u);
                                h(f, u.find("video"));
                                y(e)
                ...
                i.on("click", ".pager a[href]", function(r) {
                    r.preventDefault();
                    var e = n(this).parents("div.pager"),
                        u = e.data().pagerUrl + "/" + t.data().selectedVideo,
                        f = this.href.indexOf("?");
                    return f >= 0 && (u = u.indexOf("?") < 0 ? u + "?" + this.href.substr(f + 1) : u + "&" + this.href.substr(f + 1)), n.ajax({
                        url: u,
                        cache: !0,
                        success: function(n) {
                            var t = i.find("#videos-list");
                            t != "undefined" && t.html(n)
                        }
                    }), !1
                });
                st()
            }, st = function() {
                i.find(".uni-button").bwin_uniform();
                t = i.find("#video-player-container");
                a()
            }, a = function() {
                var n = document.player;
                n != null && n.noticeFlashReady != undefined ? n.noticeFlashReady() : window.setTimeout(a, 100)
            };
        n.bwin.videos.changeHeight = nt;
        n.bwin.videos.flashTracking = tt;
        n.bwin.videos.getVideos = it;
        n.bwin.videos.getTranslations = rt;
        n.bwin.videos.hasRequiredFlashVersion = v
    })
})(jQuery);

/*-=- Contents of sports/scripts/app/videopromotions.min.js -=-*/

(function(n) {
    n(function() {
        n.bwin.lowresourcedevice();
        n.bwin.ajaxspinner();
        n.bwin.ajaxauth();
        n.bwin.popup();
        n.bwin.onLowResourceDevice(n.bwin.browserupdate);
        n.bwin.videos()
    })
})(jQuery);

/*-=- Contents of sports/scripts/lib/videojs-4.1.0.custom.min.js -=-*/
...
var vjs, videojs, hasOwnProp, i, methodName, cx;
for (document.createElement("video"), document.createElement("audio"), document.createElement("track"), vjs = function(n, t, i) {
    var r;
    if (typeof n == "string") {
        if (n.indexOf("#") === 0 && (n = n.slice(1)), vjs.players[n]) return vjs.players[n];
        r = vjs.el(n)
    } else r = n; if (!r || !r.nodeName) throw new TypeError("The element or ID supplied is not valid. (videojs)");
    return r.player || new vjs.Player(r, t, i)
}, videojs = vjs, window.videojs = window.vjs = vjs, vjs.CDN_VERSION = "4.1", vjs.ACCESS_PROTOCOL = "https:" == document.location.protocol ? "https://" : "http://", vjs.options = {
...
}, vjs.CDN_VERSION !== "GENERATED_CDN_VSN" && (videojs.options.flash.swf = vjs.ACCESS_PROTOCOL + "vjs.zencdn.net/" + vjs.CDN_VERSION + "/video-js.swf"), vjs.players = {}, vjs.CoreObject = vjs.CoreObject = function() {}, vjs.CoreObject.extend = function(n) {
    var r, t, i;
    n = n || {};
    ...
    for (i in n) n.hasOwnProperty(i) && (t.prototype[i] = n[i]);
    return t
    ...
    var i = vjs.getData(n);
    i.handlers[t].length === 0 && (delete i.handlers[t], document.removeEventListener ? n.removeEventListener(t, i.dispatcher, !1) : document.detachEvent && n.detachEvent("on" + t, i.dispatcher));
    ...
    if (!n || !n.isPropagationStopped) {
        t = n || window.event;
        n = {};
        for (u in t) u !== "layerX" && u !== "layerY" && (n[u] = t[u]);
    ...
    var u = vjs.hasData(n) ? vjs.getData(n) : {}, i = n.parentNode || n.ownerDocument,
        r;
    return typeof t == "string" && (t = {
        type: t,
        target: n
    }), t = vjs.fixEvent(t), u.dispatcher && u.dispatcher.call(n, t), i && !t.isPropagationStopped() ? vjs.trigger(i, t) : i || t.isDefaultPrevented() || (r = vjs.getData(t.target), t.target[t.type] && (r.disabled = !0, typeof t.target[t.type] == "function" && t.target[t.type](), r.disabled = !1)), !t.isDefaultPrevented()
}, vjs.one = function(n, t, i) {
    vjs.on(n, t, function() {
        vjs.off(n, t, arguments.callee);
        i.apply(this, arguments)
    })
}, hasOwnProp = Object.prototype.hasOwnProperty, vjs.createEl = function(n, t) {
    var r = document.createElement(n || "div"),
        i;
    for (i in t) hasOwnProp.call(t, i) && (i.indexOf("aria-") !== -1 || i == "role" ? r.setAttribute(i, t[i]) : r[i] = t[i]);
    return r
    ...
    for (var r in n) hasOwnProp.call(n, r) && t.call(i || this, r, n[r])
}, vjs.obj.merge = function(n, t) {
    if (!t) return n;
    for (var i in t) hasOwnProp.call(t, i) && (n[i] = t[i]);
    return n
}, vjs.obj.deepMerge = function(n, t) {
    var i, r, u, f;
    f = "[object Object]";
    n = vjs.obj.copy(n);
    for (i in t) hasOwnProp.call(t, i) && (r = n[i], u = t[i], n[i] = vjs.obj.isPlain(r) && vjs.obj.isPlain(u) ? vjs.obj.deepMerge(r, u) : t[i]);
    return n
    ...
    if (n.className.indexOf(t) != -1) {
        for (i = n.className.split(" "), r = i.length - 1; r >= 0; r--) i[r] === t && i.splice(r, 1);
        n.className = i.join(" ")
    }
    ...
    var n = vjs.USER_AGENT.match(/Android (\d+)(?:\.(\d+))?(?:\.(\d+))*/i),
        t, i;
    return n ? (t = n[1] && parseFloat(n[1]), i = n[2] && parseFloat(n[2]), t && i ? parseFloat(n[1] + "." + n[2]) : t ? t : null) : null
}(), vjs.IS_OLD_ANDROID = vjs.IS_ANDROID && /webkit/i.test(vjs.USER_AGENT) && vjs.ANDROID_VERSION < 2.3, vjs.IS_FIREFOX = /Firefox/i.test(vjs.USER_AGENT), vjs.IS_CHROME = /Chrome/i.test(vjs.USER_AGENT), vjs.getAttributeValues = function(n) {
    var f = {}, i, r, u, t;
    if (n && n.attributes && n.attributes.length > 0)
        for (i = n.attributes, t = i.length - 1; t >= 0; t--) r = i[t].name, u = i[t].value, (typeof n[r] == "boolean" || ",autoplay,controls,loop,muted,default,".indexOf("," + r + ",") !== -1) && (u = u !== null ? !0 : !1), f[r] = u;
    return f
    ...
    var i = Math.floor(n % 60),
        ...
        e = Math.floor(t / 3600);
    return u = u > 0 || e > 0 ? u + ":" : "", r = ((u || f >= 10) && r < 10 ? "0" + r : r) + ":", i = i < 10 ? "0" + i : i, u + r + i
    ...
    return n.toString().replace(/^\s+/, "").replace(/\s+$/, "")
    ...
    var f = n.indexOf("file:") === 0 || window.location.href.indexOf("file:") === 0 && n.indexOf("http") === -1,
        r;
    ...
    r.onreadystatechange = function() {
        r.readyState === 4 && (r.status === 200 || f && r.status === 0 ? t(r.responseText) : i && i())
    };
    try {
        r.send()
    } catch (u) {
    ...
    return n.match(/^https?:\/\//) || (n = vjs.createEl("div", {
        innerHTML: '<a href="' + n + '">x<\/a>'
    }).firstChild.href), n
}, vjs.log = function() {
    ...
    init: function(n, t, i) {
        ...
        t = this.options(t);
        this.id_ = t.id || (t.el && t.el.id ? t.el.id : n.id() + "_component_" + vjs.guid++);
    ...
    if (this.isReady_ = !0, n = this.readyQueue_, n && n.length > 0) {
        for (t = 0, i = n.length; t < i; t++) n[t].call(this);
        this.readyQueue_ = [];
        this.trigger("ready")
    }
    ...
    if (t !== undefined) return this.el_.style[n] = ("" + t).indexOf("%") !== -1 || ("" + t).indexOf("px") !== -1 ? t : t === "auto" ? "" : t + "px", i || this.trigger("resize"), this;
    ...
    init: function(n, t) {
        ...
        n.ready(vjs.bind(this, this.update));
        this.boundEvents = {}
    }
    ...
    if (this.el_) {
        ...
        if (isNaN(n) && (n = 0), t = n, i) {
            var o = this.el_,
                ...
                f = n * h;
            t = f + u / 2;
            i.el().style.left = vjs.round(f * 100, 2) + "%"
        }
    ...
    init: function(n, t) {
        ...
        this.items && this.items.length === 0 && this.hide();
    ...
    if (this.options().title && t.el().appendChild(vjs.createEl("li", {
        ...
        for (n = 0; n < this.items.length; n++) t.addItem(this.items[n]);
    return t
    ...
    n.preventDefault();
    n.which == 32 || n.which == 13 ? this.buttonPressed_ ? this.unpressButton() : this.pressButton() : n.which == 27 && this.buttonPressed_ && this.unpressButton()
    ...
    init: function(n, t, i) {
        ...
        t.customControlsOnMobile !== !0 && (vjs.IS_IOS || vjs.IS_ANDROID) ? (n.controls = t.controls, this.controls_ = !1) : n.controls = !1;
        ...
        t.plugins && vjs.obj.each(t.plugins, function(n, t) {
            this[n](t)
        }, this)
    }
    ...
    if (vjs.obj.merge(t, vjs.getAttributeValues(n)), n.hasChildNodes())
        for (u = n.childNodes, r = 0, e = u.length; r < e; r++) i = u[r], f = i.nodeName.toLowerCase(), f === "source" ? t.sources.push(vjs.getAttributeValues(i)) : f === "track" && t.tracks.push(vjs.getAttributeValues(i));
    return t
    ...
    if (n.removeAttribute("width"), n.removeAttribute("height"), n.hasChildNodes()) {
        for (u = n.childNodes, f = u.length, r = []; f--;) e = u[f], o = e.nodeName.toLowerCase(), (o === "source" || o === "track") && r.push(e);
        for (i = 0; i < r.length; i++) n.removeChild(r[i])
    }
    ...
    this.tech ? this.unloadTech() : n !== "Html5" && this.tag && (this.el_.removeChild(this.tag), this.tag.player = null, this.tag = null);
    this.techName = n;
    this.isReady_ = !1;
    var r = function() {
    ...
    t && (t.src == this.cache_.src && this.cache_.currentTime > 0 && (i.startTime = this.cache_.currentTime), this.cache_.src = t.src);
    ...
    var n = this.techGet("buffered"),
        t = this.cache_.bufferEnd = this.cache_.bufferEnd || 0;
    return n && n.length > 0 && n.end(0) !== t && (t = n.end(0), this.cache_.bufferEnd = t), vjs.createTimeRange(0, t)
    ...
    if (this.isFullScreen = !0, n) {
        vjs.on(document, n.eventName, vjs.bind(this, function() {
            this.isFullScreen = document[n.isFullScreen];
            this.isFullScreen === !1 && vjs.off(document, n.eventName, arguments.callee);
            this.trigger("fullscreenchange")
        }));
        this.el_[n.requestFn]()
    } else this.tech.supportsFullScreen() ? this.techCall("enterFullScreen") : (this.enterFullWindow(), this.trigger("fullscreenchange"));
    return this
    ...
    for (var u, f, i, e, o, t = 0, r = this.options_.techOrder; t < r.length; t++)
        if (u = vjs.capitalize(r[t]), f = window.videojs[u], f.isSupported())
            for (i = 0, e = n; i < e.length; i++)
                if (o = e[i], f.canPlaySource(o)) return {
                    source: o,
                    tech: u
                };
    return !1
    ...
    if (n instanceof Array) {
        var t = this.selectSource(n),
            i;
        t ? (n = t.source, i = t.tech, i == this.techName ? this.src(n) : this.loadTech(i, n)) : this.el_.appendChild(vjs.createEl("p", {
    ...
    } else n instanceof Object ? window.videojs[this.techName].canPlaySource(n) ? this.src(n.src) : this.src([n]) : (this.cache_.src = n, this.isReady_ ? (this.techCall("src", n), this.options_.preload == "auto" && this.load(), this.options_.autoplay && this.play()) : this.ready(function() {
        this.src(n)
    }));
    return this
    ...
    return n !== undefined && this.controls_ !== n && (this.controls_ = !! n, this.trigger("controlschange")), this.controls_
    ...
    n = {};
    i.cancelFullscreen !== undefined ? (n.requestFn = "requestFullscreen", n.cancelFn = "exitFullscreen", n.eventName = "fullscreenchange", n.isFullScreen = "fullScreen") : (document.mozCancelFullScreen ? (t = "moz", n.isFullScreen = t + "FullScreen") : (t = "webkit", n.isFullScreen = t + "IsFullScreen"), i[t + "RequestFullScreen"] && (n.requestFn = t + "RequestFullScreen", n.cancelFn = t + "CancelFullScreen"), n.eventName = t + "fullscreenchange");
    document[n.cancelFn] && (vjs.support.requestFullScreen = n)
}(), vjs.ControlBar = vjs.Component.extend({
    init: function(n, t) {
        vjs.Component.call(this, n, t);
        n.controls() || this.disable();
        n.one("play", vjs.bind(this, function() {
            var n, t = vjs.bind(this, this.fadeIn),
                i = vjs.bind(this, this.fadeOut);
            if (this.fadeIn(), !("ontouchstart" in window)) {
                this.player_.on("mouseover", t);
                this.player_.on("mouseout", i);
            ...
            this.player_.on("touchend", vjs.bind(this, function(t) {
                var i;
                n && (i = this.el().className.search("fade-in"), i !== -1 ? this.fadeOut() : this.fadeIn());
                n = !1;
                this.player_.paused() || t.preventDefault()
            }))
        }))
    }
    ...
    return this.content = vjs.createEl("div", {
        ...
        "aria-live": "off"
    }), n.appendChild(vjs.createEl("div").appendChild(this.content)), n
    ...
    var i = this.player_.volume(),
        n = 3,
        t;
    for (i === 0 || this.player_.muted() ? n = 0 : i < .33 ? n = 1 : i < .67 && (n = 2), this.player_.muted() ? this.el_.children[0].children[0].innerHTML != "Unmute" && (this.el_.children[0].children[0].innerHTML = "Unmute") : this.el_.children[0].children[0].innerHTML != "Mute" && (this.el_.children[0].children[0].innerHTML = "Mute"), t = 0; t < 4; t++) vjs.removeClass(this.el_, "vjs-vol-" + t);
    ...
    return t && ("backgroundSize" in n.style ? n.style.backgroundImage = 'url("' + t + '")' : n.appendChild(vjs.createEl("img", {
        src: t
    }))), n
...
vjs.Html5 = vjs.MediaTechController.extend({
    init: function(n, t, i) {
        ...
        var r = t.source;
        r && this.el_.currentSrc == r.src ? n.trigger("loadstart") : r && (this.el_.src = r.src);
        n.ready(function() {
...
vjs.Html5.prototype.createEl = function() {
    var t = this.player_,
        n = t.tag,
        u, i, r;
    for (n && this.features.movingMediaElementInDOM !== !1 || (n ? (n.player = null, t.tag = null, t.el().removeChild(n), n = n.cloneNode(!1)) : n = vjs.createEl("video", {
        id: t.id() + "_html5_api",
        className: "vjs-tech"
    }), n.player = t, vjs.insertFirst(n, t.el())), u = ["autoplay", "preload", "loop", "muted"], i = u.length - 1; i >= 0; i--) r = u[i], t.options_[r] !== null && (n[r] = t.options_[r]);
    return n
};
vjs.Html5.prototype.setupTriggers = function() {
    for (var n = vjs.Html5.Events.length - 1; n >= 0; n--) vjs.on(this.el_, vjs.Html5.Events[n], vjs.bind(this.player_, this.eventHandler))
};
...
vjs.IS_OLD_ANDROID && (document.createElement("video").constructor.prototype.canPlayType = function(n) {
...
vjs.Flash = vjs.MediaTechController.extend({
    init: function(n, t, i) {
        ...
        if (s && (u.src = encodeURIComponent(vjs.getAbsoluteURL(s.src))), vjs.insertFirst(f, l), t.startTime && this.ready(function() {
            this.load();
            this.play();
            this.currentTime(t.startTime)
        }), t.iFrameMode !== !0 || vjs.IS_FIREFOX) vjs.Flash.embed(t.swf, f, u, h, c);
        else {
            r = vjs.createEl("iframe", {
                id: e + "_iframe",
                name: e + "_iframe",
                className: "vjs-tech",
                scrolling: "no",
            ...
            vjs.on(r, "load", vjs.bind(this, function() {
                var i, n = r.contentWindow;
                i = r.contentDocument ? r.contentDocument : r.contentWindow.document;
                i.write(vjs.Flash.getEmbedCode(t.swf, u, h, c));
                n.player = this.player_;
                n.ready = vjs.bind(this.player_, function(n) {
                    var r = i.getElementById(n),
                        u = this,
                        t = u.tech;
                    t.el_ = r;
                    vjs.on(r, "click", t.bind(t.onClick));
...
(function() {
    for (var n = 0; n < readWrite.length; n++) createGetter(readWrite[n]), createSetter(readWrite[n]);
    for (n = 0; n < readOnly.length; n++) createGetter(readOnly[n])
})();
vjs.Flash.isSupported = function() {
    return vjs.Flash.version()[0] >= 10
};
vjs.Flash.canPlaySource = function(n) {
    if (n.type in vjs.Flash.formats) return "maybe"
};
vjs.Flash.formats = {
    "video/flv": "FLV",
    "video/x-flv": "FLV",
...
vjs.Flash.onReady = function(n) {
    var t = vjs.el(n),
        r = t.player || t.parentNode.player,
        i = r.tech;
    t.player = r;
    i.el_ = t;
    i.on("click", i.onClick);
...
vjs.Flash.embed = function(n, t, i, r, u) {
    var o = vjs.Flash.getEmbedCode(n, i, r, u),
        f = vjs.createEl("div", {
            innerHTML: o
        }).childNodes[0],
        s = t.parentNode,
...
vjs.MediaLoader = vjs.Component.extend({
    init: function(n, t, i) {
        var r, u, f, e;
        if (vjs.Component.call(this, n, t, i), n.options_.sources && n.options_.sources.length !== 0) n.src(n.options_.sources);
        else
...
vjs.Player.prototype.addTextTracks = function(n) {
    for (var t, i = 0; i < n.length; i++) t = n[i], this.addTextTrack(t.kind, t.label, t.language, t);
    return this
};
vjs.Player.prototype.showTextTrack = function(n, t) {
    for (var e = this.textTracks_, r = 0, o = e.length, i, u, f; r < o; r++) i = e[r], i.id() === n ? (i.show(), u = i) : t && i.kind() == t && i.mode() > 0 && i.disable();
...
vjs.TextTrack.prototype.parseCues = function(n) {
    for (var r, f, e, u = n.split("\n"), t = "", o, i = 1, s = u.length; i < s; i++)
        if (t = vjs.trim(u[i]), t) {
            for (t.indexOf("-->") == -1 ? (o = t, t = vjs.trim(u[++i])) : o = this.cues_.length, r = {
                id: o,
                index: this.cues_.length
            }, f = t.split(" --> "), r.startTime = this.parseCueTime(f[0]), r.endTime = this.parseCueTime(f[1]), e = []; u[++i] && (t = vjs.trim(u[i]));) e.push(t);
            r.text = e.join("<br/>");
            this.cues_.push(r)
        }
    this.readyState_ = 2;
...
vjs.TextTrack.prototype.update = function() {
    ...
    if (this.cues_.length > 0 && (i = this.player_.currentTime(), this.prevChange === undefined || i < this.prevChange || this.nextChange <= i)) {
        ...
        for (i >= this.nextChange || this.nextChange === undefined ? t = this.firstActiveIndex !== undefined ? this.firstActiveIndex : 0 : (f = !0, t = this.lastActiveIndex !== undefined ? this.lastActiveIndex : s.length - 1);;) {
            if (n = s[t], n.endTime <= i) u = Math.max(u, n.endTime), n.active && (n.active = !1);
            else if (i < n.startTime) {
                if (r = Math.min(r, n.startTime), n.active && (n.active = !1), !f) break
            } else f ? (h.splice(0, 0, n), o === undefined && (o = t), e = t) : (h.push(n), e === undefined && (e = t), o = t), r = Math.min(r, n.endTime), u = Math.max(u, n.startTime), n.active = !0; if (f)
                if (t === 0) break;
                else t--;
                else if (t === s.length - 1) break;
            else t++
        }
        this.activeCues_ = h;
        this.nextChange = r;
        this.prevChange = u;
        this.firstActiveIndex = e;
        this.lastActiveIndex = o;
        this.updateDisplay();
        this.trigger("cuechange")
    }
};
vjs.TextTrack.prototype.updateDisplay = function() {
    for (var t = this.activeCues_, i = "", n = 0, r = t.length; n < r; n++) i += '<span class="vjs-tt-cue">' + t[n].text + "<\/span>";
...
vjs.TextTrackDisplay = vjs.Component.extend({
    init: function(n, t, i) {
        vjs.Component.call(this, n, t, i);
        n.options_.tracks && n.options_.tracks.length > 0 && this.player_.addTextTracks(n.options_.tracks)
    }
});
...
vjs.OffTextTrackMenuItem.prototype.update = function() {
    for (var i = this.player_.textTracks(), n = 0, u = i.length, t, r = !0; n < u; n++) t = i[n], t.kind() == this.track.kind() && t.mode() == 2 && (r = !1);
    this.selected(r)
};
...
vjs.TextTrackButton.prototype.createItems = function() {
    var t = [],
        i, n;
    for (t.push(new vjs.OffTextTrackMenuItem(this.player_, {
        kind: this.kind_
    })), n = 0; n < this.player_.textTracks().length; n++) i = this.player_.textTracks()[n], i.kind() === this.kind_ && t.push(new vjs.TextTrackMenuItem(this.player_, {
        track: i
    }));
    return t
};
...
vjs.ChaptersButton.prototype.createItems = function() {
    for (var i = [], t, n = 0; n < this.player_.textTracks().length; n++) t = this.player_.textTracks()[n], t.kind() === this.kind_ && i.push(new vjs.TextTrackMenuItem(this.player_, {
        track: t
    }));
    return i
};
vjs.ChaptersButton.prototype.createMenu = function() {
    ...
    if (r = this.menu = new vjs.Menu(this.player_), r.el_.appendChild(vjs.createEl("li", {
        className: "vjs-menu-title",
        innerHTML: vjs.capitalize(this.kind_),
        tabindex: -1
    })), i)
        for (f = i.cues_, n = 0, u = f.length; n < u; n++) s = f[n], e = new vjs.ChaptersTrackMenuItem(this.player_, {
            track: i,
            cue: s
        }), h.push(e), r.addChild(e);
    return this.items.length > 0 && this.show(), r
};
vjs.ChaptersTrackMenuItem = vjs.MenuItem.extend({
    init: function(n, t) {
        var u = this.track = t.track,
            i = this.cue = t.cue,
            r = n.currentTime();
        t.label = i.text;
...
vjs.JSON;
typeof window.JSON != "undefined" && window.JSON.parse === "function" ? vjs.JSON = window.JSON : (vjs.JSON = {}, cx = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, vjs.JSON.parse = function(n, t) {
    function r(n, i) {
        var f, e, u = n[i];
...
vjs.autoSetup = function() {
    var t, n, f, i = document.getElementsByTagName("video"),
        r, u;
    if (i && i.length > 0)
        for (r = 0, u = i.length; r < u; r++)
            if (n = i[r], n && n.getAttribute) n.player === undefined && (t = n.getAttribute("data-setup"), t !== null && (t = vjs.JSON.parse(t || "{}"), f = videojs(n, t)));
            else {
